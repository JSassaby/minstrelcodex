export const languages = {
  'en-GB': {
    ...
    storage: { local: 'Local Storage', usb: 'USB Drive (simulated)', dropbox: 'Dropbox (coming soon)', gdrive: 'Google Drive (coming soon)' },
  ...
  'af': {
    ...
    storage: { local: 'Plaaslike Berging', usb: 'USB-skyf (gesimuleer)', dropbox: 'Dropbox (binnekort)', gdrive: 'Google Drive (binnekort)' },
